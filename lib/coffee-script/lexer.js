(function() {
  var BOOL, CALLABLE, CODE, COFFEE_ALIASES, COFFEE_ALIAS_MAP, COFFEE_KEYWORDS, COMMENT, COMPARE, COMPOUND_ASSIGN, HEREDOC, HEREDOC_ILLEGAL, HEREDOC_INDENT, HEREGEX, HEREGEX_OMIT, IDENTIFIER, INDEXABLE, INVERSES, JSTOKEN, JS_FORBIDDEN, JS_KEYWORDS, LINE_BREAK, LINE_CONTINUER, LOGIC, Lexer, MATH, MULTILINER, MULTI_DENT, NOT_REGEX, NOT_SPACED_REGEX, NUMBER, OPERATOR, REGEX, RELATION, RESERVED, Rewriter, SHIFT, SIMPLESTR, TRAILING_SPACES, UNARY, WHITESPACE, compact, count, ext, exts, key, last, starts, _i, _len, _ref, _ref2;
  ...
  exports.Lexer = Lexer = (function() {
    ...
    Lexer.prototype.literalToken = function() {
      var ext, match, prev, tag, val, value, _i, _len, _ref3, _ref4, _ref5, _ref6, _ref7;
      ...
      if (value === '=' && prev) {
        if (!prev[1].reserved && (_ref4 = prev[1], __indexOf.call(JS_FORBIDDEN, _ref4) >= 0)) {
          this.error("Reserved word \"" + (this.value()) + "\" can't be assigned");
        }
        if ((_ref5 = prev[1]) === '||' || _ref5 === '&&') {
      ...
      if (value === ';') {
        ...
        if (value === '(' && (_ref6 = prev[0], __indexOf.call(CALLABLE, _ref6) >= 0)) {
          if (prev[0] === '?') prev[0] = 'FUNC_EXIST';
          tag = 'CALL_START';
        } else if (value === '[' && (_ref7 = prev[0], __indexOf.call(INDEXABLE, _ref7) >= 0)) {
          tag = 'INDEX_START';
          switch (prev[0]) {
            case '?':
              prev[0] = 'INDEX_SOAK';
  ...
  for (_i = 0, _len = exts.length; _i < _len; _i++) {
    ext = exts[_i];
    if (ext.stage === 'lexer' && ext.type === 'coffee_keywords') {
