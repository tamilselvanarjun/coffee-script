(function() {
  var Parser, alt, alternatives, ext, exts, grammar, name, o, operators, token, tokens, unwrap, _i, _len, _ref;
  ...
  grammar = {
    ...
    Statement: [
      o('Return'), o('Throw'), o('Comment'), o('Exporting'), o('STATEMENT', function() {
  ...
  for (name in grammar) {
    ...
    grammar[name] = (function() {
      var _j, _k, _len2, _len3, _ref2, _results;
      _results = [];
      for (_j = 0, _len2 = alternatives.length; _j < _len2; _j++) {
        alt = alternatives[_j];
        _ref2 = alt[0].split(' ');
