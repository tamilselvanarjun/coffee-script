(function() {
  var Access, Arr, Assign, Base, Block, Call, Class, Closure, Code, Comment, Existence, Extends, For, IDENTIFIER, IDENTIFIER_STR, IS_STRING, If, In, Index, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, Literal, METHOD_DEF, NEGATE, NO, Obj, Op, Param, Parens, RESERVED, Range, Return, SIMPLENUM, Scope, Slice, Splat, Switch, TAB, THIS, Throw, Try, UTILITIES, Value, While, YES, cls, compact, del, ends, ext, extend, exts, flatten, last, merge, multident, name, node, starts, unfoldSoak, utility, _i, _j, _len, _len2, _ref, _ref2;
  ...
  exports.Switch = Switch = (function() {
    ...
    Switch.prototype.jumps = function(o) {
      var block, conds, _k, _len3, _ref3, _ref4, _ref5;
      if (o == null) {
        o = {
          block: true
        };
      ...
      for (_k = 0, _len3 = _ref3.length; _k < _len3; _k++) {
        _ref4 = _ref3[_k], conds = _ref4[0], block = _ref4[1];
    ...
    Switch.prototype.compileNode = function(o) {
      var block, body, code, cond, conditions, expr, i, idt1, idt2, _k, _len3, _len4, _ref3, _ref4, _ref5, _ref6;
      idt1 = o.indent + TAB;
      ...
      for (i = 0, _len3 = _ref4.length; i < _len3; i++) {
        ...
        for (_k = 0, _len4 = _ref6.length; _k < _len4; _k++) {
          cond = _ref6[_k];
